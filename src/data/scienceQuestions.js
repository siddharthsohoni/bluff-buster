const scienceQuestionPool = {
  ...
  trueStatements: [
    ...
    "The immune system includes the spleen and lymph nodes",
    "Viruses are not considered living organisms",
    "Human bones are made of calcium phosphate",
    "The human body maintains a stable internal temperature",
    ...
    "Volcanoes release gases and lava",
    ...
    "Deforestation impacts biodiversity",
    ...
    "The Earth's magnetic field protects from solar wind",
    "Earth's atmosphere is mostly nitrogen",
    "Carbon dioxide is a greenhouse gas",
    "Tsunamis are caused by undersea earthquakes",
    "Minerals have a definite crystal structure",
    ...
    "Electric current flows in a circuit",
    ...
    "Motion can be described with speed and direction",
    ...
    "Electricity can be generated by moving magnets through coils",
    "Seasons are caused by the tilt of Earth's axis",
    "Dolphins communicate using clicks and whistles",
    "The liver detoxifies chemicals in the blood",
    ...
    "Carbon is essential to all known life forms",
    "Diamonds are made of carbon",
    "Arthropods have segmented bodies and exoskeletons",
    "The periodic table has over 100 elements",
    "Mars has two moons: Phobos and Deimos",
    "Sound cannot travel through a vacuum",
    "The Richter scale measures earthquake magnitude",
    "The brainstem controls basic life functions",
    "Earth is the third planet from the Sun",
    "The tongue has taste receptors for sweet, salty, sour, bitter, and umami",
    "Birds have hollow bones to aid flight",
    ...
    "Caterpillars turn into butterflies through metamorphosis",
    "Earth's core is primarily made of iron and nickel",
    "Water expands when it freezes",
    "The dew point is the temperature at which air becomes saturated",
    "The pancreas regulates blood sugar levels",
    "Air pressure decreases with altitude",
    "Electric eels can produce an electric shock",
    ...
    "Wind is a form of kinetic energy",
    "Melanin determines skin color",
    "X-rays can penetrate soft tissue but not dense bone",
    "Copper is a good conductor of electricity",
    "Some metals are magnetic, like iron and cobalt",
    "The kidneys filter blood to form urine",
    "Tectonic plates float on the semi-fluid asthenosphere",
    "Lava is magma that has reached the Earth's surface",
    "Anemia is caused by a lack of red blood cells or hemoglobin",
    "The cerebellum coordinates muscle movement",
    ...
    "The pH of blood is slightly basic, around 7.4",
    "Antibodies help the body fight infections",
    "A neutron star is denser than the Sun",
    "Rocks can be classified as igneous, sedimentary, or metamorphic",
    ...
    "Redshift indicates an object is moving away in space",
    "Lichens are symbiotic organisms made of fungi and algae",
    ...
    "Sunlight contains visible and invisible radiation",
    "Lightning can strike the same place more than once",
    "Some amphibians can breathe through their skin",
    "The human ear helps with both hearing and balance",
    "Heredity is the passing of traits from parents to offspring",
    "Coal is a fossil fuel formed from ancient plant matter",
    "Oil and natural gas are formed from ancient marine organisms",
    "The vacuum of space is not completely empty",
    ...
    "The body's pH is tightly regulated to stay within a narrow range",
    "Mars has the largest volcano in the solar system",
    "Genetic information is carried by DNA",
    "The heart pumps blood through a network of vessels",
    "The body uses enzymes to digest food",
    "Space telescopes avoid atmospheric distortion",
    "Some insects can walk on water due to surface tension",
    "The polar ice caps reflect sunlight, helping regulate Earth's temperature",
    "Energy from food is measured in calories",
    "The Moon has phases due to its position relative to Earth and the Sun",
  ...
  bluffs: [
    ...
    "Water conducts electricity on its own",
    "Lightning never strikes the same place twice",
    "Sugar causes hyperactivity in children",
    "Vaccines cause autism",
    "Gold is the heaviest element",
    ...
    "Humans have more than one stomach",
    "You can see air particles with the naked eye",
    ...
    "The human tongue has zones for different tastes",
    "Ostriches bury their heads in the sand",
    "We swallow eight spiders a year in our sleep",
    "You need to drink 8 glasses of water exactly every day",
    "Humans have blue blood until exposed to air",
    "The equator is the hottest place on Earth",
    "Humans and dinosaurs coexisted",
    "Evolution is just a theory with no evidence",
    "An object in motion will eventually stop on its own without any force",
    "The Moon has a dark side that never sees sunlight",
    "Blood is blue inside the body",
    "Body heat escapes mostly through the head",
    "You can catch a cold from being cold",
    "Lightning only happens during storms",
    "Pluto is still considered a planet",
    "Earth is perfectly round",
    "Sharks can smell a drop of blood from miles away",
    "Birds will die if you touch their babies",
    "Carbon dioxide is only harmful to humans",
    "The poles of a magnet can be separated",
    "In space, there is no gravity at all",
    "Alcohol kills brain cells permanently",
    "Humans are the only animals that use tools",
    "The Sahara Desert is the largest desert in the world by size",
    "The Moon's gravity causes earthquakes",
    "Humans are born with all the bones they will ever have",
    "A full moon causes people to behave strangely",
    "Water spirals differently down the drain depending on the hemisphere",
    "If you touch a toad, you get warts",
    "Cracking knuckles causes arthritis",
    "A tomato is a vegetable scientifically",
    "The Sun is on fire like a giant ball of flames",
    "Bacteria cannot survive in extreme cold",
    "Clouds are weightless",
    "Space is completely silent",
    "Only male birds sing",
    "All mammals give birth to live young",
    "If you go into space without a suit, you explode",
    "You need gravity to breathe",
    "The Moon doesn't rotate",
    "All plants are green",
    "Fire has no weight",
    "The Internet is stored in the clouds",
    "The color black absorbs cold",
    "Stars twinkle because they flicker like fire",
    "If something sinks, it's heavier than water",
    "Humans can't grow new brain cells",
    "Plants sleep at night",
    "The North Star is the brightest star in the night sky",
    "Earth's atmosphere is the same at all altitudes",
    "Spicy food burns your tongue physically",
    "Astronauts float in space because there is no gravity",
    "Light has no mass so it cannot be affected by gravity",
    "Water boils at 100°C regardless of location",
    "Energy is lost in every energy transformation",
    "Cold is a substance that enters your body",
    "Sound can travel through a vacuum",
    "All metals are magnetic",
    "The Sun changes color as it sets",
    "The inside of Earth is filled with magma only",
    "Solar eclipses happen every month",
    "Bacteria are only found in dirty places",
    "If it's cloudy, UV rays can't reach you",
    "Saturn is the only planet with rings",
    "Venus is cooler than Mercury because it's farther from the Sun",
    "Electricity moves at the speed of light",
    "If you can't see it, it's not real",
    "Time is the same everywhere on Earth",
    "You can see stars during the day from space",
    "Earth's magnetic field is constant and unchanging",
    "Water is a living element",
    "All gases are invisible",
    "The Sun rises in the west",
    "People float better in freshwater than saltwater"
    // ...add more bluffs as needed
  ]
};

export default scienceQuestionPool;